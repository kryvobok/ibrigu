...
<form class="woocommerce-cart-form cartContent__wrapper" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<h1 class="cartContent__title sm"><?php the_title(); ?></h1>
					...
					<div class="cartContent__item">
						...
						<div class="cartContent__itemContent">
							<div class="cartContent__itemTop">
								<div class="cartContent__itemTitle"><?php echo $product_name; ?></div>
								<div class="cartContent__itemPrice"><?php echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); ?></div>
							</div>

							<div class="cartContent__itemBody">
								<?php 
								...
								?>
									<div class="cartContent__itemAttrs_list">
										<?php 
										if($_product->get_type() == 'variation'){
											$attributelabel = '';
											$results = $attribute;
...
<div class="cartAdditionalInfo">
	<?php while(have_rows('cart_additional_info', 'options')): the_row(); ?>
		<div class="cartAdditionalInfo__row">
			...
			if($title || $icon):
			?>
				<div class="cartAdditionalInfo__titleWrapper">
					<?php if($icon): ?>
			...
			<?php endif; ?>
			<?php if($text): ?>
				<div class="cartAdditionalInfo__text">
					<?php echo $text; ?>
				</div>
			<?php endif; ?>
		</div>
