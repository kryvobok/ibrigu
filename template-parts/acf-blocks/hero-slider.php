                ...
                ?>
                    <li>
                        <div class="hero-slider__slide row">
                            <div class="hero-slider__img__wrapper col-lg-5 col-6 d-flex justify-content-lg-end justify-content-sm-center align-items-center">
                            ...
                            <div class="hero-slider__img__wrapper col-lg-2 col-6 d-flex justify-content-center align-items-center">
                            ...
                            <div class="hero-slider__img__wrapper col-lg-5 col-8 d-flex justify-content-center align-items-center">
